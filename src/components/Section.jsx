...
const Section = () => {
    ...
    const [chatId, setChatId] = useState("-4287839022");

    // Пример массива товаров для демонстрации
    const items = [
        ...
        <>
            <Box w={"full"} h={"100vh"}>
                ...
                >
                    ...
                    <DrawerContent>
                        <DrawerCloseButton />
                        <DrawerHeader>Напишите своё мнение </DrawerHeader>

                        <DrawerBody>
                            <Input placeholder='Пишите...' value={name} onChange={(e) => setName(e.target.value)} />
                            {/* Идентификатор чата установлен по умолчанию */}
                        </DrawerBody>
                        ...
                        <DrawerFooter>
                            ...
                            <Button colorScheme='blue' onClick={TelegramPost}>Отправить</Button>
                        </DrawerFooter>
                    </DrawerContent>
                </Drawer>
